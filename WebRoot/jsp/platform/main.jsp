	...
	<div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="bootstrap/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	<iframe name="ifraRight" id="ifraRight"  src="changemapaddr.action" frameborder="0" windth="100%" height="100%" onload ="javascript:getWidth()" scrolling="auto"  style="background-color: #DADADA"></iframe>
