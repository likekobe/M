...
(function($) {
  ...
  $.cluetip = {
    ...
    template: ['<div style="background-color:#fff;border:1px solid #ddd">',
      '<div class="cluetip-outer">',
        '<h4 class="cluetip-title ui-widget-header ui-cluetip-header" style="margin-left:5px"></h4>',
...
// get dimensions and options for cluetip and prepare it to be shown
    var cluetipShow = function(bpY) {
      ...
      if (opts.sticky) {
        $closeLink = $('<div class="cluetip-close" style="float:right;margin-right:5px"><a href="#">' + opts.closeText + '</a></div>');
